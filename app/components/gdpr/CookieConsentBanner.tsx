            ...
            <div className="w-full px-4 sm:px-8 lg:px-12 py-4">
                    ...
                    <div className="flex items-start gap-3 flex-1 min-w-0">
                        ...
                        <div className="min-w-0">
                            ...
                            <p className="text-sm text-gray-500 mt-0.5 leading-relaxed">
                                We use cookies to keep the site working. With your permission, we&apos;d also like to use optional analytics cookies to understand how you use our site and improve it.{" "}
                ...
                {showDetails && (
                    <div className="mt-4 grid grid-cols-1 sm:grid-cols-3 gap-2 border-t border-gray-100 pt-4">
                        <ConsentToggle
                            title="Essential"
                            description="Required for login and core functionality. Always active."
                            enabled={true}
                            locked
                            onChange={() => { }}
                        />
                        ...
                        <ConsentToggle
                            title="Marketing"
                            description="Allows us to show you relevant ads on other platforms."
                ...
                <div className="mt-2 flex items-center gap-1.5 text-[11px] text-gray-400">
                    ...
                    <span>GDPR compliant · Your choice is saved in your browser only</span>
                </div>
            </div>
        </div>
    );
...
function ConsentToggle({ title, description, enabled, locked, onChange }: ConsentToggleProps) {
    return (
